...
namespace BlazorSignalR.Shared
{
    ...
    {
        public const string HUBURL = "/DataHub";
        ...
        /// </remarks>
        public DataClient(string username, string siteUrl)
        {
            // check inputs
        ...
        public async Task StartAsync()
        {
            if (!_started)
            {
                ...
                _hubConnection.On<string, string>("UpdateData", (user, message) =>
                {
        ...
        public async Task GetQuoteAsync()
        {
            ...
            if (!_started)
                throw new InvalidOperationException("Client not started");
            // send the message
            await _hubConnection.SendAsync("GetQuote",_username);
        }
        ...
        {
            Console.WriteLine("DataClient: Disposing");
            await StopAsync();
        }
    }
